...
const api = {
  ...
  workspace: {
    ...
    readBinaryFile: (
      ...
      return ipcRenderer.invoke("workspace:readBinaryFile", {
        threadId,
        filePath,
      });
    },
    ...
    onFilesChanged: (
      ...
      const handler = (
        _: unknown,
        data: { threadId: string; workspacePath: string },
      ): void => {
        callback(data);
      };
  ...
  skills: {
    listSources: (): Promise<string[]> =>
      ipcRenderer.invoke("skills:listSources"),
    ...
    writeSkillMarkdown: (
      ...
      ipcRenderer.invoke("skills:writeSkillMarkdown", {
        threadId,
        folderName,
        content,
      }),
    renameSkillFolder: (
      ...
      ipcRenderer.invoke("skills:renameSkillFolder", {
        threadId,
        oldName,
        newName,
      }),
